...
class PlaybackServiceTest {
    ...
    @Test
    fun onDestroy_returnsQuicklyAndSchedulesPersistenceDrain() {
        ...
        assertTrue(elapsedMs < 250, "Expected non-blocking service destroy, but took ${elapsedMs}ms")
        ...
        waitForCondition {
            playbackStore.savedPositions.isNotEmpty() && queueHistoryStore.pushedMediaIds.isNotEmpty()
        }
